...
> **合図**: `IHL-DOC-REMED MAD` · **作業票**: [`../../../../docs/planning/audits/WorkOrder-05-MICRO.json`](../../../../docs/planning/audits/WorkOrder-05-MICRO.json)  
...
`WorkOrder-05-MICRO.json` の各スライス（1 route / 1 モデル / 1 エラー / 1 req_id）が **1 ファイルずつ**書かれる場所。Best-of-N の Auto ワーカーは **1 スライスだけ**を担当し、ここに成果物を置く。

## ディレクトリ

| dir | 種 | 命名 | 例 |
|-----|----|------|----|
| `api/` | api-1route | `<method>-<path>.md` | `post-api-v1-observation-search.md` |
| `schema/` | schema-field | `<model>.md` | `observationcommitbody.md` |
...
- **owner**: auto | tier-a
- **type**: api-1route | schema-field | error-code | screen-state | fr-1id
- **inputs**: 作業票の inputs
