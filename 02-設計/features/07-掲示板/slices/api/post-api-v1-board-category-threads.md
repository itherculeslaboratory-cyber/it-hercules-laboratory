---
slice_id: 07-MICRO-api-004
method: POST
path: /api/v1/board/{category}/threads
auth: public
---

# 07-MICRO-api-004 — POST /api/v1/board/{category}/threads
...
200 JSON — handler `board_create_thread`
...
apps/api/routes/board.py · board_create_thread
