...
OBS-RX-RD-03 — 01-要件 · DET v3 整合（status=unknown · 粉飾禁止）。

## 1文正規化（IN → Transform → OUT）

| 段 | 内容 |
|----|------|
| **IN** | route/UI 入力 · 要件 OBS-RX-RD-03 |
| **Transform** | IHL 実装 · event store / route 契約 |
| **OUT** | JSON 応答 · 投影 · gap は明示 |

## 受入基準

1. OBS-RX-RD-03 文言と DET §2–§7 整合。
