  ...
  return (
    <aside className="lab-sidebar">
      <header className="lab-sidebar-header">
        ...
        <span className="lab-badge">port 3101 · W2 実験 · apps/web 非接触</span>
      </header>
      <nav className="lab-nav">
        ...
        <div>
          ...
          <Link
            to="/s/PR"
            className={`nav-link nav-link--w2${activeId === "PR" ? " active" : ""}`}
          >
            PR プロフィール 3 指標
          </Link>
          <Link
            to="/s/PRnotif"
            className={`nav-link nav-link--w2${activeId === "PRnotif" ? " active" : ""}`}
          >
            PRnotif 通知
          </Link>
        </div>
