...
> **機械**: doc-layering-00.json · impl-gap-00.json
...
[
  {
    "slice_id": "00-DET-s2-schema",
    "owner": "auto",
    "inputs": [
      "01-要件/00-*.md データ契約節",
      "02-設計/features/*土台*/詳細設計-v2.md §2"
    ],
    "outputs": [
      "02-設計/features/*/00-*/詳細設計-v3-slices/s2-schema.md"
    ],
    "acceptance": "§2 フィールド表 · enum · INSERT ONLY 注記"
  },
  {
    "slice_id": "00-DET-s3-api",
    "owner": "auto",
    "inputs": [
      "apps/api/routes/*.py",
      "REQ API 節 → DET へ移行"
    ...
    "outputs": [
      "02-設計/features/*/00-*/詳細設計-v3-slices/s3-api.md"
    ],
    "acceptance": "§3 route 表: method/path/auth/errors"
  },
  {
    "slice_id": "00-DET-s7-gap",
    "owner": "auto",
    "inputs": [
      "impl-gap-NN.json",
      "詳細設計-v2.md §7"
    ...
    "outputs": [
      "02-設計/features/*/00-*/詳細設計-v3-slices/s7-gap.md"
    ],
...
正本: `docs/planning/audits/WorkOrder-00.json`

---

## 6. テスト / RTM

- RTM status 分布: review:28 · existing:22 · planned:10 · xref:1 · human:1
...
- `node scripts/ihl-design-impl-parity-check.mjs --feature 00`
- routes 宣言: 
