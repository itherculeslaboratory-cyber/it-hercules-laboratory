...
3. 最終要件定義書 第7章の保留 11 件(Q1〜Q4 の4問 + 根拠不足 10 件のうち B2 で未解消分。V3-AUT-03 セッション方式含む)
...
### 次スレッドの作業(Phase B 残り)
- **B5**(動画量産パイプライン設計)・**B6**(wiki 分割統合設計 — 技術選定は B2 で先行済み)・**B7**(改善ループ/KPI/夜間運転設計 — 設計キューは B4 に反映済み)・B1 英語版(最終要件定義書の英訳)
