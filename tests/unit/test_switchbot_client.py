...
def test_extract_meter_readings_from_status_body() -> None:
    ...
    from libs.ihl.env.switchbot_client import extract_meter_readings_from_switchbot_status
...
def test_switchbot_configured_with_primary_env(monkeypatch) -> None:
    from libs.ihl.env.switchbot_client import is_switchbot_configured
...
def test_switchbot_configured_with_legacy_alias_env(monkeypatch) -> None:
    from libs.ihl.env.switchbot_client import get_switchbot_credentials_from_env, is_switchbot_configured
